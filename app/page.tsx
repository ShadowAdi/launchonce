                ...
                {[
                  ...
                  >
                    <div className="w-6 h-6 rounded-full bg-(--color-orange)/20 flex items-center justify-center flex-shrink-0">
                      <CheckCircle2 className="w-4 h-4" style={{ color: 'var(--color-orange)' }} />
                    </div>
      ...
      <section className="py-32 px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: <ClipboardList className="w-8 h-8" style={{ color: 'var(--color-orange)' }} />,
                title: 'Document Forms',
                description: 'Add forms directly to your documents for instant feedback and engagement'
              },
              {
                icon: <Share2 className="w-8 h-8" style={{ color: 'var(--color-pink)' }} />,
                title: 'Public Forms',
                description: 'Create standalone forms that work anywhere—surveys, registrations, contact forms'
              },
              {
                icon: <Languages className="w-8 h-8" style={{ color: 'var(--color-orange)' }} />,
                title: 'Multi-language Support',
                description: 'Forms automatically adapt to visitor language, responses stay organized'
              }
            ].map((item, i) => (
              <motion.div
                key={i}
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="text-8xl font-bold opacity-10 mb-4" style={{ color: 'var(--color-orange)' }}>
                  {item.step}
                </div>
